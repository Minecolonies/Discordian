package com.minecolonies.chatchaindc.modules.translate.commands;

import com.jagrosh.jdautilities.command.CommandEvent;
import com.minecolonies.chatchaindc.internal.BotCommand;
import com.minecolonies.chatchaindc.util.GoogleTranslate;
        ...
        else
        {
            ...
            else
            {
                ...
                catch (Exception e)
                {
                    ...
                    this.getChatChainDC().getLogger().info("Translation attempt Errored: ", e);
                }
            }
        }
    }
